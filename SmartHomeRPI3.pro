...
LIBS += -L/usr/local/lib -lwiringPi #para que funcione en cross-compiling hay que hacer el clone+build en RPi y copiar el .so a [ubuntu]/usr/local/lib
